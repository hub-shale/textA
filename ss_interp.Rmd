...
# 60 Years Later, How Are We Talking About _Silent Spring_?

This summer will mark the 60th anniversary of Rachel Carson's groundbreaking book _Silent Spring_ revealing the may environmental harms of pesticides in American agriculture (if you're unfamiliar, it's a [must-read](http://www.rachelcarson.org/SilentSpring.aspx)). Of course, that's just me saying it's a must-read; but this (my last!) quarter in grad school I am taking a course in [Text and Sentiment Analysis for Environmental Problems](https://bren.ucsb.edu/courses/eds-231), and this past week I was provided with the skills to try and understand what everyone else is saying about _Silent Spring_ as well. 

This post will explore the sentiment of `r length(dat$articles$ID)` articles containing the search string "Silent Spring" accessed from Nexis Uni, an extension of the LexisNexis database for academic institutions (subscription access provided through UCSB).

# Load & Clean Nexis Uni Data
...
This sentiment analysis is based on a search for the term "Silent Spring" on the Nexus Uni database. The results are rather surprising, given the gloomy topic of that book; but of course the texts analyzed here are at best responses to Rachel Carson's famous book, and occasionally completely unrelated. Across the entire 5 year span from 2017 to 2022, trust was the most prevalent emotion detected, followed generally by anticipation and fear. Joy also became more prominent starting in late 2019. Consistently the least frequently coded emotions are surprise, anger, and disgust.
